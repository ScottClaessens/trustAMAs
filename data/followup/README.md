...
**Dataset title:** Clean data from follow-up study for project on 
"Cross-Cultural Trust in Artificial Moral Advisors" in long format
...
**File dimensions:** 1980 rows x 29 columns

**Overall number of unique participants**: N = 990

**Country of data collection:** United Kingdom

**Data collected on:** 10th March 2026

**Data collected from:** Prolific Academic
...
- Did not state that they currently lived in the United Kingdom
...
Note that we retained participants that failed the attention and comprehension 
checks in this clean dataset, so that the data could be analysed with and 
without these participants.

**Columns in the dataset:**

- `id` - numeric, participant identification number
- `treatment` - character, randomly assigned treatment, human or AI
- `wording` - character, randomly assigned wording, original or revised
- `attention1` - character, response to the first attention check question. The
...
- `attention2` - character, response to the second attention check question. The
question was "Within the last 6 months, have you invented a new cryptocurrency 
that has surpassed Bitcoin in market value?" The expected answer is "No"
